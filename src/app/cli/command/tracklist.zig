...
pub fn run(allocator: std.mem.Allocator, args: parser_types.TracklistArgs) !command_types.CommandResult {
    ...
    const output = try presenter.tracklistResult(allocator, &list, args);
